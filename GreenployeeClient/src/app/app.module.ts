...
import { ModalOrdemServicoVisualizarComponent } from './views/modal-ordem-servico-visualizar/modal-ordem-servico-visualizar.component';
...
@NgModule({
  declarations: [
    ...
    ModalOrdemServicoVisualizarComponent,
  ],
  imports: [
    BrowserModule,
    FormsModule,
